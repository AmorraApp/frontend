...
import { cl as classNames, map, isFunction, isNotUndefinedOrNull, omit } from 'common/utils';
import PropTypes from 'prop-types';

export default function divWithClassName (className, name, { as: As = 'div', propTypes, propClassMap, ...props } = {}) {
